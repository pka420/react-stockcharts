...
import { isDefined, isNotDefined, getAxisCanvas, GenericChartComponent } from '../core';
...
export class PointAndFigureSeries extends React.Component<PointAndFigureSeriesProps> {
  ...
  public render() {
    ...
    return (
      <GenericChartComponent clip={clip} canvasDraw={this.drawOnCanvas} canvasToDraw={getAxisCanvas} drawOn={['pan']} />
    );
  }
