...
export class BarSeries extends React.Component<BarSeriesProps> {
  public static defaultProps = {
    baseAt: (xScale: ScaleContinuousNumeric<number, number>, yScale: ScaleContinuousNumeric<number, number> /* , d*/) =>
      head(yScale.range()),
    clip: true,
  ...
  public render() {
    ...
    return (
      <GenericChartComponent clip={clip} canvasToDraw={getAxisCanvas} canvasDraw={this.drawOnCanvas} drawOn={['pan']} />
    );
  }
